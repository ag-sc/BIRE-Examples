...
public class ImmutableEntityAnnotation extends AbstractEntityAnnotation {

	public ImmutableEntityAnnotation(State state, EntityType entityType, Multimap<ArgumentRole, VariableID> arguments,
			int start, int end) {
