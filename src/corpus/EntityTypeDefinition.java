...
public class EntityTypeDefinition implements Serializable {
	...
	public EntityTypeDefinition(String type) {
		this.type = type;
		this.coreArguments = new HashMap<ArgumentRole, Argument>();
		this.optionalArguments = new HashMap<ArgumentRole, Argument>();
	}

	public EntityTypeDefinition(String type, Map<ArgumentRole, Argument> coreArguments,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EntityTypeDefinition other = (EntityTypeDefinition) obj;
		if (type == null) {
			if (other.type != null)
				return false;
